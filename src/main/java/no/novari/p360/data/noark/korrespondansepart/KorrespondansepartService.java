package no.novari.p360.data.noark.korrespondansepart;

import lombok.extern.slf4j.Slf4j;
import no.fint.model.resource.arkiv.noark.KorrespondansepartResource;
import no.fint.model.resource.arkiv.noark.SkjermingResource;
import no.novari.p360.data.exception.CreateContactException;
import no.novari.p360.data.exception.CreateEnterpriseException;
import no.novari.p360.data.exception.EnterpriseNotFound;
import no.novari.p360.data.noark.skjerming.SkjermingService;
