...
import no.novari.fint.p360.data.noark.codes.CaseCategoryService;
import no.novari.fint.p360.data.noark.codes.ResponseCodeService;
import no.novari.fint.p360.data.noark.codes.dokumentstatus.DokumentstatusService;
import no.novari.fint.p360.data.noark.codes.dokumenttype.DokumenttypeService;
import no.novari.fint.p360.data.noark.codes.filformat.FilformatResource;
import no.novari.fint.p360.data.noark.codes.filformat.FilformatService;
import no.novari.fint.p360.data.noark.codes.journalposttype.JournalpostTypeService;
import no.novari.fint.p360.data.noark.codes.journalstatus.JournalStatusService;
import no.novari.fint.p360.data.noark.codes.klasse.KlasseService;
import no.novari.fint.p360.data.noark.codes.klassifikasjonssystem.KlassifikasjonssystemService;
import no.novari.fint.p360.data.noark.codes.korrespondanseparttype.KorrespondansepartTypeService;
import no.novari.fint.p360.data.noark.codes.merknadstype.MerknadstypeService;
import no.novari.fint.p360.data.noark.codes.partrolle.PartRolleService;
import no.novari.fint.p360.data.noark.codes.saksmappetype.SaksmappetypeService;
import no.novari.fint.p360.data.noark.codes.saksstatus.SaksStatusService;
import no.novari.fint.p360.data.noark.codes.skjermingshjemmel.SkjermingshjemmelService;
import no.novari.fint.p360.data.noark.codes.tilgangsgruppe.TilgangsgruppeService;
import no.novari.fint.p360.data.noark.codes.tilgangsrestriksjon.TilgangsrestriksjonService;
import no.novari.fint.p360.data.noark.codes.tilknyttetregistreringsom.TilknyttetRegistreringSomService;
import no.novari.fint.p360.data.noark.codes.variantformat.VariantformatService;
