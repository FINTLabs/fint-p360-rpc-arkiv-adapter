package no.novari.fint.p360.data.noark.journalpost;
...
import no.novari.fint.p360.config.DocumentArgsConfiguration;
import no.novari.fint.p360.data.noark.dokument.DokumentbeskrivelseFactory;
import no.novari.fint.p360.data.noark.korrespondansepart.KorrespondansepartFactory;
import no.novari.fint.p360.data.noark.korrespondansepart.KorrespondansepartService;
import no.novari.fint.p360.data.noark.skjerming.SkjermingService;
...
import static no.novari.fint.p360.data.utilities.P360Utils.getLinkTargets;
