package no.novari.fint.p360.data.noark.common;
...
import no.novari.fint.p360.data.exception.GetDocumentException;
import no.novari.fint.p360.data.exception.IllegalCaseNumberFormat;
import no.novari.fint.p360.data.noark.codes.klasse.KlasseFactory;
import no.novari.fint.p360.data.noark.journalpost.JournalpostFactory;
import no.novari.fint.p360.data.noark.part.PartFactory;
import no.novari.fint.p360.data.noark.part.PartService;
import no.novari.fint.p360.data.p360.DocumentService;
import no.novari.fint.p360.data.utilities.FintUtils;
import no.novari.fint.p360.data.utilities.NOARKUtils;
import no.novari.fint.p360.model.ContextUser;
import no.novari.fint.p360.model.FilterSet;
import no.novari.fint.p360.repository.KodeverkRepository;
import no.novari.fint.p360.service.ContextUserService;
