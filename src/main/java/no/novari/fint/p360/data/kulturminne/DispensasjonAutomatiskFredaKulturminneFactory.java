package no.novari.fint.p360.data.kulturminne;
...
import no.novari.fint.p360.data.exception.NotDispensasjonAutomatiskFredaKulturminneException;
import no.novari.fint.p360.data.noark.common.NoarkFactory;
import no.novari.fint.p360.data.noark.journalpost.JournalpostFactory;
import no.novari.fint.p360.data.utilities.Constants;
import no.novari.fint.p360.data.utilities.FintUtils;
import no.novari.fint.p360.data.utilities.P360Utils;
import no.novari.fint.p360.data.utilities.QueryUtils;
import no.novari.fint.p360.model.FilterSet;
import no.novari.fint.p360.service.CaseQueryService;
