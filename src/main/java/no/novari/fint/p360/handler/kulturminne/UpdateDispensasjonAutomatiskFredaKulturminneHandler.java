...
import no.novari.fint.p360.data.exception.*;
import no.novari.fint.p360.data.kulturminne.DispensasjonAutomatiskFredaKulturminneFactory;
import no.novari.fint.p360.data.kulturminne.DispensasjonAutomatiskFredaKulturminneService;
