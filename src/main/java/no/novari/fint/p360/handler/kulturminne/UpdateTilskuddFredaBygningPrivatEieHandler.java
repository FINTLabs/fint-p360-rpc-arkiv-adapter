package no.novari.fint.p360.handler.kulturminne;
...
import no.novari.fint.p360.data.exception.*;
import no.novari.fint.p360.data.kulturminne.TilskuddFredaBygningPrivatEieFactory;
import no.novari.fint.p360.data.kulturminne.TilskuddFredaBygningPrivatEieService;
import no.novari.fint.p360.data.p360.CaseService;
...
import no.novari.fint.p360.service.P360CaseDefaultsService;
import no.novari.fint.p360.service.ValidationService;
    ...
    private void updateCase(Event<FintLinks> response, String query, TilskuddFredaBygningPrivatEieResource tilskuddFredaHusPrivatEieResource) {
        ...
        try {
            ...
            tilskuddFredaBygningPrivatEieService.getTilskuddFredaBygningPrivatEieForQuery(query, response);
                 ...
                 NotTilskuddFredaHusPrivatEieException e) {
            response.setResponseStatus(ResponseStatus.REJECTED);
