package no.novari.fint.p360.service

import com.fasterxml.jackson.databind.ObjectMapper
import com.google.common.cache.LoadingCache
import no.novari.fint.p360.AdapterProps
import no.novari.fint.p360.service.CachedFileService
...
class CachedFileServiceSpec extends Specification {
    ...
    void setup() {
        ...
        cache = Mock()
        cachedFileService = new CachedFileService(files: cache, objectMapper: new ObjectMapper(),
                props: new AdapterProps(endpointBaseUrl: "url", cacheSpec: "default", cacheDirectory: path))
    }
