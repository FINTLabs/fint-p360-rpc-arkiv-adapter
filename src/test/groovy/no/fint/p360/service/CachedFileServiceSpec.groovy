...
class CachedFileServiceSpec extends Specification {
    ...
    void setup() {
        ...
        cache = Mock()
        cachedFileService = new CachedFileService(files: cache, objectMapper: new ObjectMapper(), props: new AdapterProps(p360User: "RA/TEST", p360AuthKey: "topsecret", cacheDirectory: path))
    }
